...
```
java -Dspring.profiles.active=production -jar ./target/gestion-CreditBancaire-0.0.1-SNAPSHOT.jar
```
...
```
mvnw spring-boot:build-image -Dspring-boot.build-image.imageName=boukhrit.soufiane/gestion-credit-bancaire
```
